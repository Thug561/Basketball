"use strict";
/**
 * Generated by the Babylon.JS Editor v4.1.0
 */
...
function requireScriptForNodes(scene, scriptsMap, nodes) {
    ...
    // Initialize nodes
    for (var _i = 0, _m = nodes; _i < _m.length; _i++) {
        var n = _m[_i];
    ...
    var _loop_1 = function (i) {
        ...
        var _loop_3 = function (link) {
            var ps = scene_3.particleSystems.filter(function (ps) { return ps.emitter === n && ps.name === link.particleSystemName; })[0];
        ...
        for (var _c = 0, animationGroupLinks_1 = animationGroupLinks; _c < animationGroupLinks_1.length; _c++) {
            var link = animationGroupLinks_1[_c];
        ...
        for (var _d = 0, soundLinks_1 = soundLinks; _d < soundLinks_1.length; _d++) {
            var link = soundLinks_1[_d];
            _loop_4(link);
        }
        // Check pointer events
        var pointerEvents = (_j = e.default._PointerValues) !== null && _j !== void 0 ? _j : [];
        var _loop_5 = function (event_1) {
            scene_3.onPointerObservable.add(function (e) {
                var _a;
        ...
        for (var _e = 0, pointerEvents_1 = pointerEvents; _e < pointerEvents_1.length; _e++) {
            var event_1 = pointerEvents_1[_e];
            _loop_5(event_1);
        }
        // Check keyboard events
        var keyboardEvents = (_k = e.default._KeyboardValues) !== null && _k !== void 0 ? _k : [];
        var _loop_6 = function (event_2) {
            scene_3.onKeyboardObservable.add(function (e) {
        ...
        for (var _f = 0, keyboardEvents_1 = keyboardEvents; _f < keyboardEvents_1.length; _f++) {
            var event_2 = keyboardEvents_1[_f];
            _loop_6(event_2);
        }
        // Retrieve impostors
        if (n instanceof abstractMesh_1.AbstractMesh && !n.physicsImpostor) {
            n.physicsImpostor = (_l = n._scene.getPhysicsEngine()) === null || _l === void 0 ? void 0 : _l.getImpostorForPhysicsObject(n);
        }
        delete n.metadata.script;
    };
    // Configure initialized nodes
    for (var _o = 0, initializedNodes_1 = initializedNodes; _o < initializedNodes_1.length; _o++) {
        var i = initializedNodes_1[_o];
        _loop_1(i);
    }
    dummyScene.dispose();
}
...
function attachScripts(scriptsMap, scene) {
    ...
    var _loop_7 = function (scriptKey) {
...
function configurePostProcesses(scene, rootUrl) {
    ...
    if (((_b = data.screenSpaceReflections) === null || _b === void 0 ? void 0 : _b.json) && !exports.screenSpaceReflectionPostProcessRef) {
        ...
        exports.screenSpaceReflectionPostProcessRef = new screenSpaceReflectionPostProcess_1.ScreenSpaceReflectionPostProcess(data.screenSpaceReflections.json.name, scene, 1.0, scene.activeCamera);
